...
class Config:
    ...
    def describe(self) -> List[Tuple[str, str, bool]]:
        ...
        rows = [
            ...
            ("driver.tdxquant.hqmp_port", str(self.tdxquant.hqmp_port)),
            ("driver.tdxquant.hqmp_capture", str(self.tdxquant.hqmp_capture or "(未设)")),
            ("driver.tdxquant.hqmp_enable_trade",
             "true" if self.tdxquant.hqmp_enable_trade else "false"),
            ("driver.tdxquant.hqmp_reuse_tc",
             "true" if self.tdxquant.hqmp_reuse_tc else "false"),
            ("driver.tdxquant.hqmp_max_order_size",
             str(self.tdxquant.hqmp_max_order_size)),
            ("driver.tdxquant.hqmp_max_order_notional",
             str(self.tdxquant.hqmp_max_order_notional)),
